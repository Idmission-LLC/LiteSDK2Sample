...
6) As per requirement download the framework zip file which is mentioned in [SDK Flavours Download Links](#quick-links-to-get-started-with-identity-sdk-for-ios) section. On downloading the zip file, unzip it & you will be able to see respective frameworks files in unzipped folder.  
